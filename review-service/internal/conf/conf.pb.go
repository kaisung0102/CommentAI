...
type Bootstrap struct {
	...
	UniqueId      *UniqueID              `protobuf:"bytes,3,opt,name=unique_id,json=uniqueId,proto3" json:"unique_id,omitempty"`
...
func (x *Bootstrap) GetUniqueId() *UniqueID {
	if x != nil {
		return x.UniqueId
	}
	return nil
...
type UniqueID struct {
	...
	Machine_ID    int64                  `protobuf:"varint,2,opt,name=machine_ID,json=machineID,proto3" json:"machine_ID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UniqueID) GetStartTime() string {
	if x != nil {
		return x.StartTime
	}
	return ""
...
func (x *UniqueID) GetMachine_ID() int64 {
	if x != nil {
		return x.Machine_ID
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\x121\n" +
	"\tunique_id\x18\x03 \x01(\v2\x14.kratos.api.UniqueIDR\buniqueId\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*UniqueID)(nil),            // 3: kratos.api.UniqueID
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.unique_id:type_name -> kratos.api.UniqueID
